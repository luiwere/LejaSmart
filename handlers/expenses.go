...
func Expenses(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodGet:
		...
		expenses, err := db.GetExpenses(getSessionRole(r), getSessionShopID(r), vendorID)
		if err != nil {
	...
	case http.MethodPost:
		...
		err := db.AddExpense(getSessionRole(r), getSessionShopID(r), e.VendorID, e.Amount, e.Date, e.Category, e.SupplierName, e.Notes)
		if err != nil {
	...
	case http.MethodDelete:
		...
		err := db.DeleteExpense(getSessionRole(r), getSessionShopID(r), id)
		if err != nil {
